...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--model_type', type=str, default='OpenAIModel', help='The type of translation model to use. Choose between "GLMModel" and "OpenAIModel".')        
        ...
        self.parser.add_argument('--openai_model', default='gpt-3.5-turbo', type=str, help='The model name of OpenAI Model. Required if model_type is "OpenAIModel".')
        ...
        self.parser.add_argument('--target_language', type=str, help='The target language for translation')
